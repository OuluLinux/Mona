#ifndef _MuzzWorld_MuzzWorld_h_
#define _MuzzWorld_MuzzWorld_h_
...
// For conditions of distribution and use, see copyright notice in the repository
...
// Block terrain.
// See BlockTerrain.h for terrain generation parameters.
